/**
 * @author akhilesh raperthy
 */
function ScoreBoardWindow(title) {
	var url = 'http://www.espncricinfo.com/rss/content/story/feeds/586733.xml';//'http://static.espncricinfo.com/rss/livescores.xml';//'http://www.cs.odu.edu/~araperth/ipl13/feeds.xml'
